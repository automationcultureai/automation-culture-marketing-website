    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-container flex-col gap-12 pt-16 sm:gap-24">
        <div className="flex flex-col items-center gap-6 text-center sm:gap-12">
          ...
          {/* Title */}
          <h1 className="relative z-10 inline-block animate-hero-title text-5xl font-semibold leading-tight text-[#1a1a1a] drop-shadow-2xl sm:text-6xl sm:leading-tight md:text-8xl md:leading-tight">
            {title}
          </h1>
